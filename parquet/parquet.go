...
type LogicalType struct {
	...
	INTERVAL *IntervalType `thrift:"INTERVAL,9" db:"INTERVAL" json:"INTERVAL,omitempty"`
...
var LogicalType_INTERVAL_DEFAULT *IntervalType

func (p *LogicalType) GetINTERVAL() *IntervalType {
	if !p.IsSetINTERVAL() {
		return LogicalType_INTERVAL_DEFAULT
	}
	return p.INTERVAL
}
...
func (p *LogicalType) IsSetINTERVAL() bool {
...
func (p *LogicalType) ReadField9(ctx context.Context, iprot thrift.TProtocol) error {
	p.INTERVAL = &IntervalType{}
	if err := p.INTERVAL.Read(ctx, iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.INTERVAL), err)
	}
	return nil
}
...
func (p *LogicalType) writeField9(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetINTERVAL() {
		if err := oprot.WriteFieldBegin(ctx, "INTERVAL", thrift.STRUCT, 9); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 9:INTERVAL: ", p), err)
		}
		if err := p.INTERVAL.Write(ctx, oprot); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.INTERVAL), err)
		}
		if err := oprot.WriteFieldEnd(ctx); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 9:INTERVAL: ", p), err)
		}
	}
	return err
}
...
func (p *LogicalType) Equals(other *LogicalType) bool {
	...
	if !p.INTERVAL.Equals(other.INTERVAL) { return false }
